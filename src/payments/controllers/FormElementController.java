...
public class FormElementController {
    ...
    public Response<String> addFormElement(String name, String serviceName, String providerName, FormElementType type,
        ...
        if (formElementRelation.recordExists(
            ...
            return new Response<String>(false, "This form element already exists");
        formElementRelation
                .insert(new FormElement(name, serviceName, providerName, type, info));
        return new Response<String>(true, "Form element added successfully");
    }
}
